...
class GCNDataset(ONMTDatasetBase):
    ...
    def __init__(self, fields, src_examples_iter, tgt_examples_iter,
                 label_examples_iter, node1_examples_iter, node2_examples_iter, morph_iter='', src2_examples_iter='',
        ...
        if tgt_examples_iter is not None:
            if morph_iter == '':
                if src2_examples_iter == "":
                    ...
                    examples_iter = (self._join_dicts(src, label, node1, node2, tgt, src2) for src, label, node1, node2, tgt, src2 in
                                     zip(src_examples_iter, label_examples_iter, node1_examples_iter,
                                         node2_examples_iter, tgt_examples_iter, src2_examples_iter))
            else:
            ...
            if src2_examples_iter == "":
                ...
                examples_iter = (self._join_dicts(src, label, node1, node2, src2) for
                                 src, label, node1, node2, src2 in
                                 zip(src_examples_iter, label_examples_iter, node1_examples_iter,
                                     node2_examples_iter, src2_examples_iter))
        ...
        src_size = 0    # length of the src sequence

        out_examples = []   #list of all the trian/test examples.
        # each instance is an Example instance, which contains src, tgt, labels, node1, node2 and index
    ...
    def make_text_examples_nfeats_tpl(path, truncate, side):
        ...
        """
        assert side in ['src', 'src2', 'tgt', 'label', 'node1', 'node2', 'morph']
    ...
    def get_fields(n_src_features, n_tgt_features):
        ...
        def make_src(data, vocab, is_train=False):  # data: list of tensor, each tensor is a unpadded id list of the source
        ...
        def make_tgt(data, vocab, is_train=False):
        ...
        fields["label"] = torchtext.data.Field(
            use_vocab=True, dtype=torch.int64,
            sequential=True)
