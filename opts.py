...
def model_opts(parser):
    ...
    group.add_argument('-single_encoder', action="store_true",
                       help='Use the major encoder only.')
    group.add_argument('-encoder2_type', type=str, default='none',
                       choices=['rnn', 'brnn', 'mean', 'transformer', 'cnn', 'gcn', 'none'],
                       help="""Type of encoder layer to use. Non-RNN layers
                           are experimental. Options are
                           [rnn|brnn|mean|transformer|cnn|gcn].""")
...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_src2', required=False,
                       help="Path to the training source data 2")
    ...
    group.add_argument('-valid_src2', required=False,
                       help="Path to the validation source data 2")
    ...
    group.add_argument('-tgt_seq_length', type=int, default=500,
...
def plan_opts(parser):
    # Data options
    group = parser.add_argument_group('Data')
    group.add_argument('-data_type', default="text",
                       help="""Type of the source input.
                       Options are [text|img].""")
    group.add_argument('-model_output', default="data/planner.pt",
                       help='output path of the planning model')

    group.add_argument('-use_old_plan', action="store_true",
                       help='Use the already generated plan.')
    group.add_argument('-model', default="",
                       help='path of the pre-trained planning model')

    group.add_argument('-train_src', required=False,
                       help="Path to the training source data")
    group.add_argument('-train_src2', required=False,
                       help="Path to the training source data 2")
    group.add_argument('-train_label', required=False,
    ...
    group.add_argument('-train_node2', required=False,
                       help="Path to the training source data")
    group.add_argument('-train_plan', required=False,
                       help="Path to the training source data")
    group.add_argument('-train_split', required=False,
                       help="Path to the training source data")

    group.add_argument('-valid_src', required=False,
                       help="Path to the validation source data")
    group.add_argument('-valid_src2', required=False,
                       help="Path to the validation source data 2")
    group.add_argument('-valid_label', required=False,
    ...
    group.add_argument('-valid_node2', required=False,
                       help="Path to the training source data")
    group.add_argument('-valid_plan', required=False,
                       help="Path to the training source data")
    
    group.add_argument('-test_src', required=False,
                       help="Path to the test source data")
    group.add_argument('-test_src2', required=False,
                       help="Path to the test source data 2")
    group.add_argument('-test_label', required=False,
                       help="Path to the training source data")
    group.add_argument('-test_node1', required=False,
                       help="Path to the training source data")
    group.add_argument('-test_node2', required=False,
                       help="Path to the training source data")
    group.add_argument('-test_plan', required=False,
                       help="Path to the training source data")
...
def train_opts(parser):
    ...
    group.add_argument('-use_dgl', action='store_true',
                       help="""Whether to use the dgl framework.""")
    ...
    group.add_argument('-pre_word_vecs_enc2',
                       help="""If a valid path is specified, then this will load
                           pretrained word embeddings on the encoder side.
                           See README for specific formatting instructions.""")
    ...
    group.add_argument('-fix_word_vecs_enc2',
                       action='store_true',
                       help="Fix word embeddings on the encoder side.")
...
def translate_opts(parser):
    ...
    group.add_argument('-src',   required=True,
                       ...
                       sequence)""")
    group.add_argument('-src2', required=False,
                       help="""Source sequence to decode (one line per
                           sequence)""")
    ...
    group.add_argument('-src_dir',   default="",
                       help='Source directory for image or audio files')
    group.add_argument('-src_triple', default="",
                       help='Source directory for triple files')
